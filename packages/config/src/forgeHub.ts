...
const STANDALONE_TOOLS: ForgeTool[] = [
    ...
    {
        name: 'Crafting Component Wizard',
        description: 'Create crafting component loot items (tissues, hides, venoms) with quality tiers — generates TRE, loot items, loot groups, and Lua templates.',
        command: 'craftingComponentWizard.open'
    },
    {
        name: 'ACM Editor',
    ...
    {
        name: 'Building Composer',
        description: 'Assemble building interiors — clone a vanilla building, swap cells from a catalog of 291 POBs, auto-align portals, and generate all output files.',
        command: 'buildingComposer.open'
    },
    {
    ...
    },
    {
        ...
        description: 'Browse all tangible objects, trace loot lineage (items → groups → creatures), detect craftability, and generate schematic chains.',
        command: 'objectExplorer.open'
    },
    {
        name: 'Combat Simulator',
        description: 'Simulate combat encounters — step-by-step damage, armor, hit chance, DPS, force drain, and TTK calculations from C++ formulas.',
        command: 'combatSim.open'
    },
    {
        name: 'Transaction Log Viewer',
        description: 'Search and browse transaction logs — player trades, vendor purchases, loot, crafting — with player name resolution and date filtering.',
        command: 'transactionViewer.open'
    },
];
